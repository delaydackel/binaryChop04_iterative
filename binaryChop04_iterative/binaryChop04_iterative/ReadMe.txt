========================================================================
    KONSOLENANWENDUNG: binaryChop04_iterative-Projektübersicht
========================================================================

Diese binaryChop04_iterative-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre binaryChop04_iterative-Anwendung besteht.


binaryChop04_iterative.vcxproj
...
binaryChop04_iterative.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen binaryChop04_iterative.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
